...
#Enabling logging to see multi-query generation
logging.basicConfig()
...
def multi_query_retriever():
    # the idea is to hit the llm with 1 query and get multiple queries, to have a more expanded result 
    ...
    retriever = MultiQueryRetriever.from_llm(
        retriever=vector_store.as_retriever(search_kwargs= {"k": 2}), llm = llm
    )
